 ...
 */
@BTrace(unsafe = true)
public class ExceptionBean3Script {

	@OnMethod(clazz = "com.zhenghongfei.btracesamples.exception.ExceptionBean3", method = "traceException", location = @Location(Kind.CATCH))
